    ...
    <div class="container mx-auto">
        <div class="footer-main">
            <div class="footer-detail w-full xl:w-[30%]">
                ...
                <p class="footer-desc">Leather jackets have long been a quintessential wardrobe staple. Not only are they virtually effortless to wear, but they also suit every season: a casual evening cover-up for warmer months, or a stunning </p>
                <div class="icon-sec">
                    <a href="" class="icon-box group">
