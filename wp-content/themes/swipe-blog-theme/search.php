      ...
      <div class="page-content">
        ...
        <div class="bg-[#FE4705] py-[40px] md:pt-[16px] md:pb-[28px] 2xl:py-[100px]">
            <div class="container mx-auto">
                <form class="input-sec" method="GET" action="<?php echo home_url('/'); ?>">
                    <input type="text" id="default-search" 
                    class="input-field" placeholder="Type &amp; Hit Enter..." 
                    name="s" value="<?php echo esc_attr( get_search_query() ); ?>" required="">
                </form>
            </div>
        </div>
                        ...
                        <div class="modal-body">
                            ...
                            if ( ! empty( $search_query ) ) :
                                ...
                                if ( $q->have_posts() ) :
                                    ...
                                    <p class="py-10 text-center text-lg">No results found for <strong><?php echo esc_html( $search_query ); ?></strong>. Please try a different keyword.</p>
                                <?php endif;

                            else : ?>
                                <p class="py-10 text-center text-lg">Please enter a search term above.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
